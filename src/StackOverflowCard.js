  ...
  return `
    <svg width="214" height="312" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <text stroke-linecap="square" stroke-linejoin="bevel" fill="${isDark ? '#F2F2F3' : '#0f0f0f'}"
        ...
        <tspan y="200">${data.display_name}</tspan>
      </text>
      ...
      <path d="M21 267h49a2 2 0 012 2v22a2 2 0 01-2 2H21a2 2 0 01-2-2v-22a2 2 0 012-2" fill="${isDark ? '#5E553C' : '#fff4d1'}"
        fill-rule="nonzero" />
      <text transform="translate(42 273)" stroke-linecap="square" stroke-linejoin="bevel"
      ...
      <path d="M80 267h50a2 2 0 012 2v22a2 2 0 01-2 2H80a2 2 0 01-2-2v-22a2 2 0 012-2" fill="${isDark ? '#424242' : '#e8e8e8'}"
        fill-rule="nonzero" />
      <text transform="translate(101 273)" stroke-linecap="square" stroke-linejoin="bevel"
        fill="${isDark ? '#CFD2D6' : '#3c4146'}" font-family="ArialMT, Arial" font-size="11">
      ...
      <path d="M140 267h49a2 2 0 012 2v22a2 2 0 01-2 2h-49a2 2 0 01-2-2v-22a2 2 0 012-2" fill="${isDark ? '#4D433B' : '#f2e9e1'}"
        fill-rule="nonzero" />
      <text transform="translate(161 273)" stroke-linecap="square" stroke-linejoin="bevel"
        fill="${isDark ? '#CFD2D6' : '#3c4146'}" font-family="ArialMT, Arial" font-size="11">
